    ...
    <>
      ...
      >
        ...
        <div className="md:hidden">
          {/* Row 1: hamburger | ELYARA | search + cart */}
          <div className="grid grid-cols-3 items-center h-14 px-4">
            ...
            <button
              ...
              className="text-[#1a2744] justify-self-start"
            >
            ...
            {/* Centre — ELYARA wordmark */}
            <Link href="/" className="flex flex-col items-center justify-center leading-none" aria-label="Elyara home">
              <span className="font-serif text-[1.25rem] font-bold tracking-[0.22em] text-[#1a2744] uppercase">
                ELYARA
              </span>
              <span className="text-[8px] tracking-[0.25em] text-[#c9a96e] uppercase font-medium mt-0.5">
                By Sweety
              </span>
            </Link>
